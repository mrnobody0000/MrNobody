...
public class SignupUI extends JFrame implements ActionListener{
    ...
    public SignupUI() {
        ...
        b4.setBackground(new Color(0X402E2A));  //set background color
        b5.setForeground(Color.white);  //set font color
        b5.setBackground(new Color(0X402E2A));  //set background color
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==b4) {
            ...
            if (s1.equals(s2) && !t1.getText().isEmpty() && !t4.getText().isEmpty()) {
                String fileName = new String(t1.getText().trim() + ".txt");
