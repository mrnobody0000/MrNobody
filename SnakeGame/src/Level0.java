...
class Level0 extends JPanel implements ActionListener{
    ...
    Level0(int sond,int lvl,int sp) throws IOException, UnsupportedAudioFileException, LineUnavailableException {
