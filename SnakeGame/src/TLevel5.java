...
class TLevel5 extends JPanel implements ActionListener{
    ...
    TLevel5(int sond,int lvl,int sp,int ap) throws IOException, UnsupportedAudioFileException, LineUnavailableException {
    ...
    public void draw(Graphics g) throws IOException, InterruptedException {
        ...
        if(running) {
            ...
            g.drawString(" TOURNAMENT : APARTMENT ", 20, 645);
    ...
    public void checkApple() throws UnsupportedAudioFileException, LineUnavailableException, IOException, InterruptedException {
        if((x[0] == appleX) && (y[0] == appleY)) {
            ...
            //    new TEndScreen(applesEaten,runningSound,levelSelector,DELAY);
                new celebration(applesEaten,runningSound,levelSelector,DELAY);
