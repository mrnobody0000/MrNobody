...
class TLevel3 extends JPanel implements ActionListener{
    ...
    TLevel3(int sond,int lvl,int sp,int ap) throws IOException, UnsupportedAudioFileException, LineUnavailableException {
    ...
    g.setColor(Color.WHITE);
            ...
            for(int i=0;i<360;i+=15)
                g.drawImage(brick.getImage(), 255, i, UNIT_SIZE, UNIT_SIZE,null);
            ...
            g.drawString(" TOURNAMENT : MILL ", 20, 645);
    ...
    public void checkApple() throws UnsupportedAudioFileException, LineUnavailableException, IOException {
        if((x[0] == appleX) && (y[0] == appleY)) {
            ...
            if(applesEaten>6)
            {
                clip.stop();
                clip.close();
                new TGameFrame4(runningSound,levelSelector,DELAY,applesEaten);
